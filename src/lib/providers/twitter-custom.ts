import { RecursiveAmbivalent } from "@/types/mapped";
...
export interface TwitterProfile {
  data: {
    ...
    location?: string;
    withheld: {
      country_codes: Array<{ [index: string | number | symbol]: any }>;
    };
    entities?: {
      url: {
        urls: Array<{
...
export type TwitterAttribs<T extends keyof TwitterProfile["data"]> = {
  [P in T]?: TwitterProfile["data"][P];
};

export default function TwitterCustom<
  P extends Record<string, any> = TwitterProfile | TwitterLegacyProfile
>(options: OAuthUserConfig<P>): OAuthConfig<P> {
